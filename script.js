    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Pang uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e483d1da-ccaf-4380-86b5-b676dea4b758',
                    name: data.name || '',
                    email: data.email || '',
